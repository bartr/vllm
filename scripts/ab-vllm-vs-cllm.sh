...
#   B) node=cllm          - production-shape modeled node:
...
#
# Dashboard tip: filter cllm-overview by node=~"cllm|vllm"
...
echo "Dashboards: http://localhost:8088/grafana — filter node=~\"cllm|vllm\""
