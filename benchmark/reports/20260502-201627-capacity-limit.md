...
**Date:** 2026-05-02 20:16:30 UTC  
**Duration:** 60s  
**Warmup:** 15s  
**Scenario hash:** `bbdf6be21d7c`  
...
**Command:** `ask --bench 280 --duration 60s --files /home/bartr/vllm/scripts/prompts.yaml --max-tokens 100`  
**Log:** `benchmark/logs/20260502-201627-capacity-limit-default.log`

| Metric | Value |
|--------|-------|
| Total rows | 2113 |
| Warmup rows excluded | 661 |
| Cache hit rate | 46.2% |
| Avg TTFT | 1039.6 ms |
| Avg req tok/s | 9.9 |
| Avg total tok/s | 3277.7 |
