...
This builds the local container image `cllm:0.20.0`.
...
```bash
docker build -t cllm:0.20.0 .
docker save cllm:0.20.0 | sudo k3s ctr images import -
```
...
```bash
docker build -t cllm:0.20.0 .
docker run --rm -p 8080:8080 cllm:0.20.0
```
